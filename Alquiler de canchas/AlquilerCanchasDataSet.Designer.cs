...
namespace Alquiler_de_canchas {
    ...
    public partial class AlquilerCanchasDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nombre, string Apellido, int DNI, string Mail, string Rol) {
...
namespace Alquiler_de_canchas.AlquilerCanchasDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([Id_Usuario] = @Original_Id_Usuario) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_DNI = 1 AND [DNI] IS NULL) OR ([DNI] = @Original_DNI)) AND ((@IsNull_Mail = 1 AND [Mail] IS NULL) OR ([Mail] = @Original_Mail)) AND ((@IsNull_Rol = 1 AND [Rol] IS NULL) OR ([Rol] = @Original_Rol)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Nombre], [Apellido], [DNI], [Mail], [Rol]) VALUES " +
                "(@Nombre, @Apellido, @DNI, @Mail, @Rol);\r\nSELECT Id_Usuario, Nombre, Apellido, D" +
                "NI, Mail, Rol FROM Usuarios WHERE (Id_Usuario = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [DNI] = @DNI, [Mail] = @Mail, [Rol] = @Rol WHERE (([Id_Usuario] = @Original_Id_Usuario) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_DNI = 1 AND [DNI] IS NULL) OR ([DNI] = @Original_DNI)) AND ((@IsNull_Mail = 1 AND [Mail] IS NULL) OR ([Mail] = @Original_Mail)) AND ((@IsNull_Rol = 1 AND [Rol] IS NULL) OR ([Rol] = @Original_Rol)));
SELECT Id_Usuario, Nombre, Apellido, DNI, Mail, Rol FROM Usuarios WHERE (Id_Usuario = @Id_Usuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Alquiler_de_canchas.Properties.Settings.Default.AlquilerCanchasConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_Usuario, Nombre, Apellido, DNI, Mail, Rol FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_Id_Usuario, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_DNI, string Original_Mail, string Original_Rol) {
        ...
        public virtual int Insert(string Nombre, string Apellido, global::System.Nullable<int> DNI, string Mail, string Rol) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Apellido, global::System.Nullable<int> DNI, string Mail, string Rol, int Original_Id_Usuario, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_DNI, string Original_Mail, string Original_Rol, int Id_Usuario) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, global::System.Nullable<int> DNI, string Mail, string Rol, int Original_Id_Usuario, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_DNI, string Original_Mail, string Original_Rol) {
            return this.Update(Nombre, Apellido, DNI, Mail, Rol, Original_Id_Usuario, Original_Nombre, Original_Apellido, Original_DNI, Original_Mail, Original_Rol, Original_Id_Usuario);
        }
    }
